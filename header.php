...
<html>
<head>
	<title>Theresya-Hello Matters</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +62808336322</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> bit.ly/HelloMattersRecruitment</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Theresya-Hello Matters</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #192d75"><b>Theresya-Hello Matters</b></a>
			</div>

			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="index.php">Home</a></li>
					<li><a href="produk.php">Topics</a></li>
					<li><a href="about.php">About Us</a></li>
					<li><a href="manual.php">Sustainable Change</a></li>
					<?php 
					if(isset($_SESSION['kd_cs'])){
					$kode_cs = $_SESSION['kd_cs'];
					...
					$value = mysqli_num_rows($cek);
						...
						?>
						<li><a href="keranjang.php"><i class="glyphicon glyphicon-globe"></i> <b>[ <?= $value ?> ]</b></a></li>

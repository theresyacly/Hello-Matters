...
<!-- PRODUK TERBARU -->
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid #ff8680"><b>Informations</b></h2>
					...
					<div class="caption">
						...
						<div class="row">
							...
							<?php if(isset($_SESSION['kd_cs'])){ ?>
								...
								?>
								<div class="col-md-6">
									<a href="keranjang.php" class="btn btn-success btn-block" role="button"><i class="glyphicon glyphicon-question-sign"></i>Ask More</a>
								</div>
